            ...
            <div x-show="tab === 'monitor'" x-cloak class="mt-6">
                ...
                <form method="POST" class="space-y-4 mt-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <?php if ($edit_monitor): ?>
                        <a href="index.php" class="w-full text-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium bg-white hover:bg-gray-50">Cancel</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
